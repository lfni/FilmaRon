...
<header class="bg-white dark:bg-neutral-900 shadow-md fixed w-full top-0 z-50">
  <div class="container mx-auto px-4 flex items-center justify-between h-16">
    ...
    <!-- Logo -->
    <a href="/filmaron/index.php" class="text-xl font-bold text-blue-600 dark:text-blue-400">
      فیلمارون
    </a>

    <!-- Menu -->
    <nav class="hidden md:flex gap-6 text-sm font-medium">
      <a href="/filmaron/index.php" class="hover:text-blue-500">خانه</a>
      <a href="/filmaron/movies.php" class="hover:text-blue-500">فیلم‌ها</a>
      <a href="/filmaron/series.php" class="hover:text-blue-500">سریال‌ها</a>
    </nav>
